...
declare -A USERCONFIGFILES=(\
		...
		[.config/bcompare5]=${USERDATADIR}.config/bcompare5\
		...
		[.local/share/smartgit]=${USERDATADIR}.local/share/smartgit\
		[.local/share/task]=${USERDATADIR}.local/share/task\
		...
		[.ssh]=${USERDATADIR}.ssh\
		[.thunderbird]=${USERDATADIR}.thunderbird\
		[.var]=${USERDATADIR}.var\
...
declare -A USERDOTFILES=(\
		...
		[.config/vim]=${DOTFILESDIR}vim\
		[.config/task]=${DOTFILESDIR}config/task\
