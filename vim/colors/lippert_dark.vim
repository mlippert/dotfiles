...
" Modified by mjl 2022-11-04 only 256 colors, so gui colors do not match
...
if s:t_Co >= 256
  ...
  hi Comment ctermfg=221 ctermbg=NONE cterm=NONE
  hi Constant ctermfg=224 ctermbg=NONE cterm=NONE
  hi Error ctermfg=196 ctermbg=231 cterm=reverse
  hi Identifier ctermfg=42 ctermbg=NONE cterm=NONE
